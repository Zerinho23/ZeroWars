package com.zerowars.utils;
   ...
   *   - Codigos legacy Bukkit:     "&6Texto dorado"  "&lNegrita"  "&r Reset"
   */
  public final class MessageUtil {
      ...
      /**
       * Convierte codigos legacy al formato MiniMessage antes de parsear.
       *   &#RRGGBB  →  <color:#RRGGBB>
      ...
      public static String translateColors(String text) {
          if (text == null) return "";
          // Hex &#RRGGBB → <color:#RRGGBB>  (case-insensitive hex digits)
